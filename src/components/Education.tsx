  ...
  return (
    <section id="education" className="bg-gray-50 px-4 py-16 sm:px-6 sm:py-20">
      <div className="mx-auto max-w-5xl">
        ...
        {/* PDF Downloads */}
        <div className="mb-10 rounded-2xl border border-dashed border-medical-teal bg-white p-6 sm:p-8">
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            {pdfFiles.map((file, i) => (
              <a
                ...
                className="inline-flex items-center gap-1.5 rounded-full border border-primary/20 bg-primary/5 px-4 py-2 text-sm font-semibold text-primary transition-all hover:bg-primary hover:text-white hover:shadow-md"
              >
        ...
        <div className="space-y-4">
          {items.map((item, i) => (
            <div
              key={i}
              className="flex items-start gap-4 rounded-xl border border-gray-100 bg-white p-5 shadow-sm transition-all hover:shadow-md sm:p-6"
            >
