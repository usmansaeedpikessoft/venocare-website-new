    ...
    <section id="contact" className="bg-calm-mint px-4 py-16 dark:bg-gray-800 sm:px-6 sm:py-20">
      <div className="mx-auto max-w-4xl">
        <div className="grid gap-6 md:grid-cols-2">
          {/* Location Card */}
          <div className="flex flex-col justify-between rounded-2xl border border-gray-100 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-900 sm:p-8">
            <div>
              {/* Map pin icon + title */}
              ...
              <address className="mb-4 text-sm not-italic leading-relaxed text-gray-600 dark:text-gray-400">
                {t("address")}
              </address>
          ...
          {/* Email Form */}
          <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-900 sm:p-8">
            ...
            >
              ...
              <textarea
                ...
                required
                className="w-full resize-none rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm text-gray-900 outline-none transition-colors placeholder:text-gray-400 focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 dark:placeholder:text-gray-500"
              />
              <button
                type="submit"
